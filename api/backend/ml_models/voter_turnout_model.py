...
NOTE: voter_turnout_params and voter_turnout_scaler tables must exist in the
database before predict() can be used. They follow the same structure as
model2_params and model2_scaler in ngo_db.sql. Ask your teammate to add them
to the schema file before uncommenting the DB writes in train().
"""
import json
import numpy as np
import pandas as pd
...
def train():
    ...
    coefficients and scaler parameters to the DB.
