...
btn3 = st.button('Manage pending and existing lessons', type = 'primary', use_container_width=True)

if btn1:
    st.switch_page('pages/21_Voter_Turnout_Admin.py')
if btn2:
    st.switch_page('pages/22_EU_Turnout_Admin.py')
    btn3 = st.button("Approve or Reject Lessons", type="primary", use_container_width=True)
if btn3:
